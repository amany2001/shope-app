...
class AppColors{
  ...
  static final Color buttonbackgroundolor = const  Color(0xFFf7f6f4);
 ...
 // static final Color backgroun1 = const Color(0xFF69c5df);
 // static final Color backgroun2 =const Color(0xFF9294cc);
}